...
public class Seminar3{
    public static void main(String[] args) {
        ...
        //desk[7][0] = 1;
        //Ferz(desk);
        //System.out.println(Row(desk, 1));
        //System.out.println(Col(desk, 1));
        //System.out.println(Diag1(desk, 2,5));
        //System.out.println(Diag2(desk, 1,5));
        //PrintDesk(desk);
        PrintDesk(Posit());
